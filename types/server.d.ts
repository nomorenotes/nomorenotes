...
declare type ServerType = SIOServer<ClientToServerEvents, ServerToClientEvents> & NMNServer;
declare type ClientSocket = SIOSocket<ClientToServerEvents, ServerToClientEvents> & NMNClientSocket & { [rs]: NMNClientData };
...
declare interface R {
	...
	mes: (who: Emittable<ServerToClientEvents>, prefix: Prefix, msg: string, sender?: { id: string }) => void
}
